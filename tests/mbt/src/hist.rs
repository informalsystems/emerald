...
use malachitebft_eth_types::{Address, BlockHash, ProposalPart, Value, ValueId as EmeraldValueId};
...
impl History {
    ...
    pub fn get_proposal(&self, value_id: &EmeraldValueId) -> Result<Proposal> {
        self.proposals
            .get_by_right(value_id)
            .cloned()
